...
describe("LibResolver", () => {
  ...
  describe("getDirectories", () => {
    it("should list existing directories", () => {
      expect(resolver.getDirectories("/")).to.have.members([
        "lib_one",
        "lib_two",
        "nested",
        "oops",
      ...
      expect(resolver.getDirectories("/oops/super/nested/with/only/one")).to.be
        .empty;
    });
...
describe("StripPrefixResolver", () => {
  ...
  describe("getDirectories", () => {
    it("should list existing directories", () => {
      ...
      expect(resolver.getDirectories("/etc/node_modules")).to.have.members([
        "lib_one",
        "lib_two",
        "nested",
        "oops",
      ...
      expect(
        resolver.getDirectories("/etc/node_modules/nested")
